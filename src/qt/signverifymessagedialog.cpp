    ...
    model(0)
{
    ...
    ui->addressIn_SM->setPlaceholderText(tr("Enter a NeoGulden address"));
    ui->signatureOut_SM->setPlaceholderText(tr("Click \"Sign Message\" to generate signature"));

    ui->addressIn_VM->setPlaceholderText(tr("Enter a NeoGulden address"));
    ui->signatureIn_VM->setPlaceholderText(tr("Enter NeoGulden signature"));
#endif
